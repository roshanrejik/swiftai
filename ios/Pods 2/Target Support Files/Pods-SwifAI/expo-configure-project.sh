...
with_node \
  ...
  --target "/Users/roshanrejik/Desktop/swiftai_mobileapp-master/ios/Pods/Target Support Files/Pods-SwifAI/ExpoModulesProvider.swift" \
  --entitlement "/Users/roshanrejik/Desktop/swiftai_mobileapp-master/ios/SwifAI/SwifAI.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-camera" "expo-clipboard" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-speech-recognition" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
